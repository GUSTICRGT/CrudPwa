...
import HerramientaSteper from './HerramientaSteper';
...
class NuevoVehiculo extends Component
{
    ...
    cambiarSocio = (e) => {
        ...
        this.state.socios.forEach(s => {
            if (s.getKey() === e.target.value) {
                ...
                this.setState({socioSelect: s, vehiculos: vehiculos});
            }
        });
    }
    ...
    handleRegistrarCambio = () => {
        ...
        cambioNombreTransaccion.nuevoVehiculoTransaccion(_newVehiculoSelected)
            .then(() => {
                this.notificationDOMRef.current.addNotification({
                    title: "<< TRANSACCIÓN >>",
                    message: "Nuevo vehículo registrado correctamente",
                    type: "success",
                    insert: "bottom",
                                            ...
                                            (this.state.newVehiculo === null) ?
                                                ...
                                                <div>
                                                    ...
                                                    <Dialog fullScreen open={this.state.openModal} TransitionComponent={this.Transition}>
                                                        ...
                                                        <Typography align={'center'} color={'primary'} variant={'h3'} >Nuevo Vehículo</Typography>
                                                        <List>
                                                            <ListItem>
